...
export const translations = {
  de: {
    ...
    surpriseMeSub: "Zufälliges Land + Jahr — los geht's!",
    surpriseToast: "Zufällige Auswahl!",
    surpriseToastDesc: "Generiere Fakten für {country} ({year})…",
  ...
  en: {
    ...
    surpriseMeSub: "Random country + year — let's go!",
    surpriseToast: "Random pick!",
    surpriseToastDesc: "Generating facts for {country} ({year})…",
    leaderboardTitle: "🏆 Top 10 Leaderboard",
    leaderboardEmpty: "Be the first on the leaderboard!",
    leaderboardLoading: "Loading leaderboard…",
    leaderboardYourRank: "Your rank",
    submitScore: "Add me to the leaderboard",
    submittingScore: "Saving…",
